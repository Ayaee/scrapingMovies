...
if __name__ == "__main__":
    ...
    #movieName = input("Welcome to ScrapMovie, which film do you want to know about? \n")
    movieName = "Dune"
    ...
    while True:
        movieDetails["name"] = getName(movie)
        choose = input("\n What kind of information do you want to know about {movie}\n "
                       "Would you like to know more about 'Runtime', 'Rating', 'Release Date', 'Genres', 'Plot Summary', 'Director', 'Story', 'Writers' ou 'Casting'\n "
                       "Choose to write only what you want otherwise write 'Bye'\n".format(movie=movieDetails["name"]))
        ...
        elif choose == "Plot Summary":
            movieDetails["plot"] = getPlot(movie)
            print("Plot summary: \n", movieDetails["plot"])

        elif choose == "Director":
